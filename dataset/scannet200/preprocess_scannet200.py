...
np.save('dataset/scannet200/reverse_norm_ids.npy', REVERSE_NORMALIZED_CKASS_IDS_200_np)
...
def handle_process(scene_path, output_path, labels_pd, train_scenes, val_scenes):
    ...
    torch.save((pointcloud[:, :3] / 127.5 - 1.0, pointcloud[:, 3:6], labelled_pc.reshape(-1), instance_ids.reshape(-1)), output_file)
